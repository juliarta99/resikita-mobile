...
export default function Beranda() {
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.hero}>
            <Text style={styles.heroTitle}>
              Ekonomi Sirkular untuk Bumi Bersih
            </Text>
  ...
  const aksi: Item[] = [
    { key: "bank", label: "Bank Sampah", icon: "refresh-ccw", go: soon },
    {
      key: "scan",
      label: "Scan AI",
      icon: "zap",
    ...
    { key: "tarik", label: "Tarik Saldo", icon: "credit-card", go: soon },
    {
      key: "edukasi",
      label: "Edukasi",
      icon: "book-open",
    ...
    <SafeAreaView style={styles.screen} edges={["top"]}>
      ...
      >
        ...
        <View style={styles.pencapaianHead}>
          ...
          <Pressable
            onPress={() => router.push("/pencapaian" as Href)}
